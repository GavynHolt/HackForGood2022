export default function ContributeBanner() {
    return (
        <div className="banner px-8 py-8 m-8 rounded-lg flex flex-col items-center justify-center">
            ...
            <button className="font-uber bg-transparent hover:bg-blue-500 text-white font-semibold py-2 px-4 border border-white hover:border-transparent rounded mt-8">
                Learn More
            </button>
        </div>
    );
