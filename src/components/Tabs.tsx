        ...
        <>
            <div className="wrapper z-20">
                <div className="navbar">
                    ...
                    <div className={`navbar__item -navy-blue ${path.includes('/add') ? 'active' : ''}`} onClick={() => navigate('/add')}>
                        <span className="navbar__icon">
                            <svg className="icon">
                    ...
                    <div className={`navbar__item -yellow ${path.includes('/discover') ? 'active' : ''}`} onClick={() => navigate('/discover')}>
                        <span className="navbar__icon">
                            <svg className="icon">
